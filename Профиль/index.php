...
<html>
    ...
    <body>
        <div class="header">
            ...
            <div class="profile">   
                <a href="index.php"><svg xmlns="http://www.w3.org/2000/svg" width="46" height="45" viewBox="0 0 46 45" fill="none">
            ...
            <div class="block1">
                ...
                <div class="date">
                    ...
                    <div class="date2">
                        <p>Фамилия</p>
                        <div class="conclusion">
                            <input type="text" name="last_name" placeholder="Фамилию" value="<?= $user['last_name']; ?>">
                        </div>
                    </div>
                    <div class="date2">
                        <p>Email</p>
                    ...
                    <div class="date2">
                        <p>Телефон</p>
                        <div class="conclusion">
                            <input type="tel" name="login" placeholder="Телефон" value="<?= $user['login']; ?>">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="footer">
            <div class="link_footer">
                ...
                <div class="link_footer1"><a href="../Карта зоопарка/index.html">Карта зоопарка</a></div>
